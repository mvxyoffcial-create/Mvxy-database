...
@app.route("/api/admin/hero/batch", methods=["PUT"])
@requires_auth
def batch_update_hero():
    ...
    hero_items = data.get('hero_items', [])
    ...
    try:
        ...
        episode_data = {
            ...
            'download_720p': {
                ...
                'file_size': data.get('file_size_720p')
            ...
            'download_1080p': {
                ...
                'file_type': media['file_type'],
                'file_size': data.get('file_size_1080p')
